...
class AccueilActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        MemoriesStorage.get(applicationContext).insert(Memories(0, "Ma première randonnée en montagne", "https://www.auvergne-destination.com/wp-content/uploads/2021/10/randonne-sancy-conseil-dpartemental-140719-mickal-mussard0028-1600x900.jpg", 1, "10/10/2023", "Aujourd'hui, j'ai fait ma première randonnée en montagne. J'ai longtemps rêvé de gravir ces sommets majestueux, et enfin, l'occasion s'est présentée. La montée a été exigeante, mais chaque pas en valait la peine. Le vent frais sur mon visage, le silence paisible de la nature et les paysages à couper le souffle ont créé une expérience inoubliable. J'ai pris cette photo incroyable depuis le sommet pour immortaliser ce moment magique."))
        MemoriesStorage.get(applicationContext).insert(Memories(0, "Anniversaire surprise de Sarah", "https://tadaaz.fr/blog/wp-content/uploads/2014/08/anniversaire-surprise.jpg", 4, "10/09/2023", "Nous avons organisé une fête surprise incroyable pour l'anniversaire de Sarah. C'était une journée de planification secrète intense, mais la surprise sur son visage en valait la peine. La maison était décorée avec soin, et tous ses amis et sa famille étaient présents pour célébrer. La joie et l'émotion sur son visage lorsque nous avons allumé les bougies du gâteau resteront gravées dans ma mémoire. Nous avons partagé des rires, des histoires et des souvenirs précieux"))
        MemoriesStorage.get(applicationContext).insert(Memories(0, "Dernier jour à l'université", "https://www.southernliving.com/thmb/Nexxnzduqs1Nlrdf11M9E5k1Mnk=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/GettyImages-1162745842-2000-a03c9bdc95c747aeaa34108f18fb7018.jpg", 2, "21/07/2023", "Mon dernier jour à l'université est arrivé, et les émotions sont fortes. C'est le moment où je ferme un chapitre de ma vie et en commence un nouveau. Je me souviens des années d'études, des amis fidèles que j'ai rencontrés et des défis surmontés. C'est un mélange de joie pour ce qui est à venir et de nostalgie pour ce qui a été. Les adieux, les sourires et les larmes ont marqué ce jour spécial."))
        MemoriesStorage.get(applicationContext).insert(Memories(0, "Journée en famille au parc d'attractions", "https://www.uzes-pontdugard.com/wp-content/uploads/2023/06/16050300-diaporama-1200x8002-1.jpg", 4, "10/09/2023", "Nous avons passé une journée extraordinaire en famille au parc d'attractions. Les rires, les manèges excitants et les délicieuses glaces ont créé une atmosphère de pur bonheur. Les enfants étaient enthousiastes, les parents se sont amusés comme des enfants, et nous avons créé des souvenirs en famille qui dureront toute une vie. C'était une journée de détente, de divertissement et de complicité."))
        MemoriesStorage.get(applicationContext).insert(Memories(0, "Mon premier concert en plein air", "https://weezevent.com/wp-content/uploads/2023/01/13120315/reglementation-concert-plein-air.jpg", 4, "02/09/2023", "Hier soir, j'ai assisté à mon premier concert en plein air, et c'était une expérience incroyable. Le ciel était clair, les étoiles brillaient, et la musique résonnait dans l'air. Mon groupe préféré était sur scène, et je me sentais en symbiose avec la foule enthousiaste. Les chansons emblématiques, la danse et la camaraderie avec d'autres fans ont créé une ambiance électrique. J'ai pris une photo mémorable lorsque les feux d'artifice ont éclairé le ciel pour clore le spectacle. C'était un mélange d'émotions, de bonheur pur et d'excitation qui restera gravé dans ma mémoire. "))
